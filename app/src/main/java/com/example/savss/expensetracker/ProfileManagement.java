...
public class ProfileManagement extends Fragment {
    ...
    Button btnNext, btnPrev, btn, logOut,button,button2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button = (Button) viewapp.findViewById(R.id.rate);
        button2 = (Button) viewapp.findViewById(R.id.cal);

        button.setOnClickListener(new View.OnClickListener() {  //this is inside oncreate view
            public void onClick(View view) {
                Intent myIntent = new Intent(view.getContext(), rating.class);
                startActivityForResult(myIntent, 0);
            }

        });

        button2.setOnClickListener(new View.OnClickListener() {  //this is inside oncreate view
            public void onClick(View view) {
