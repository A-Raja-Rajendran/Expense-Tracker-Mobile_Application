...
public class AppSettings extends Fragment {
    ...
    Button btnNext, btnPrev, btnCan,btnExport;
    View viewapp;
    Toast toast;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnExport = (Button) viewapp.findViewById(R.id.export);
        btnPrev.setOnClickListener(setViewSwitcherPrev);
        btnCan.setOnClickListener(setViewSwitcherCancel);
        btnExport.setOnClickListener(setViewSwitcherexport);
        return viewapp;
    }
    private View.OnClickListener setViewSwitcherexport = new View.OnClickListener() {
        @Override
        public void onClick(final View view) {
            ...
            SQLiteToExcel sqliteToExcel = new SQLiteToExcel(getActivity(), LocalDatabaseHelper.DATABASE_NAME, directory_path);
